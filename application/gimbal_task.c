...
static void gimbal_set_control(gimbal_control_t *set_control)
{
    ...
    if (motion_rx.target_found && (set_control->gimbal_rc_ctrl->rc.s[GIMBAL_MODE_CHANNEL] == 1 || set_control->gimbal_rc_ctrl->mouse.press_r)) {
        set_control->gimbal_yaw_motor.absolute_angle_set = motion_rx.yaw_actual + gimbal_control.gimbal_yaw_motor.absolute_angle;
        set_control->gimbal_pitch_motor.absolute_angle_set = motion_rx.pitch_actual + gimbal_control.gimbal_pitch_motor.absolute_angle;
